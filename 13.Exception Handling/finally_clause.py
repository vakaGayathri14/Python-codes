...
#under elseclause there will be finally clause , there is no dependent on else clause
# finally clause will run irrespective of the error present or not even though there is error it will run
finally:
